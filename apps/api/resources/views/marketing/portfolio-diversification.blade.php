...
<head>
    ...
    <title>Are you actually diversified? | Helmio</title>
    <meta name="description" content="Owning several funds or securities does not always mean your portfolio is diversified. Helmio measures concentration and exposure.">
...
<span class="inline-flex rounded-full border border-blue-500/25 bg-blue-500/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[.16em] text-blue-300">PORTFOLIO DIVERSIFICATION</span>
<h1 class="mt-7 text-4xl font-semibold tracking-[-.04em] sm:text-5xl lg:text-6xl">Are you actually diversified?</h1>
<p class="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-400 sm:text-lg">Owning several funds or securities does not always mean your portfolio is diversified. Helmio measures concentration and exposure.</p>
<div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
<a href="{{ route('register') }}" class="inline-flex min-w-52 items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold hover:bg-blue-500">Check My Diversification →</a>
...
<h3 class="mt-5 text-lg font-semibold text-white">Largest Position</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">See how much of your portfolio is concentrated in the single largest security.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Top Holdings</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Measure how much of the portfolio is controlled by the largest positions.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Sector Exposure</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Review whether investments are concentrated in particular industries.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Asset Classes</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Understand the balance between equities, fixed income, cash, and other assets.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Fund Look-Through</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Where data is available, look through funds to their underlying exposures.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Concentration Signals</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Surface structures that may be less diversified than they appear.</p>
</article>
</div>
</div>
</section>
...
<a href="{{ route('register') }}" class="mt-8 inline-flex rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold hover:bg-blue-500">Check My Diversification →</a>
</div>
</div>
</section>
</main>
