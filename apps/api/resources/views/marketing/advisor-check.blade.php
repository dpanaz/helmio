...
<head>
    ...
    <title>Is your financial advisor really working in your best interest? | Helmio</title>
    <meta name="description" content="Helmio gives you an independent view of fees, performance, trading, diversification, risk, and tax efficiency.">
...
<span class="inline-flex rounded-full border border-blue-500/25 bg-blue-500/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[.16em] text-blue-300">FINANCIAL ADVISOR CHECK</span>
<h1 class="mt-7 text-4xl font-semibold tracking-[-.04em] sm:text-5xl lg:text-6xl">Is your financial advisor really working in your best interest?</h1>
<p class="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-400 sm:text-lg">Helmio gives you an independent view of fees, performance, trading, diversification, risk, and tax efficiency.</p>
<div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
<a href="{{ route('register') }}" class="inline-flex min-w-52 items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold hover:bg-blue-500">Check My Financial Advisor →</a>
...
<h3 class="mt-5 text-lg font-semibold text-white">Fees & Costs</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">See advisory fees, fund expenses, account fees, transaction costs, and your estimated all-in cost.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Performance</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Compare portfolio results with relevant benchmarks and view return in the context of risk.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Trading Activity</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Monitor turnover, transaction frequency, round trips, and unusual trading patterns.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Diversification</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Identify concentration across securities, sectors, asset classes, and underlying exposures.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Portfolio Risk</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Understand volatility, drawdowns, concentration, and other portfolio risk signals.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Tax Efficiency</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Review gains, holding periods, dividends, and other factors that can affect after-tax results.</p>
</article>
</div>
</div>
</section>
...
<a href="{{ route('register') }}" class="mt-8 inline-flex rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold hover:bg-blue-500">Check My Financial Advisor →</a>
</div>
</div>
</section>
</main>
