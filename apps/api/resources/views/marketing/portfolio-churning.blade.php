...
<head>
    ...
    <title>Is there too much trading in your investment account? | Helmio</title>
    <meta name="description" content="Frequent trading can create costs, taxes, and unnecessary activity. Helmio monitors turnover and transaction patterns.">
...
<span class="inline-flex rounded-full border border-blue-500/25 bg-blue-500/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[.16em] text-blue-300">PORTFOLIO CHURNING</span>
<h1 class="mt-7 text-4xl font-semibold tracking-[-.04em] sm:text-5xl lg:text-6xl">Is there too much trading in your investment account?</h1>
<p class="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-400 sm:text-lg">Frequent trading can create costs, taxes, and unnecessary activity. Helmio monitors turnover and transaction patterns.</p>
<div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
<a href="{{ route('register') }}" class="inline-flex min-w-52 items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold hover:bg-blue-500">Check My Trading Activity →</a>
...
<h3 class="mt-5 text-lg font-semibold text-white">Portfolio Turnover</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Measure how much of the portfolio is being bought and sold over time.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Trade Count</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Track transaction volume across connected investment accounts.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Round Trips</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Identify securities purchased and then sold again over relatively short periods.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Trading Fees</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">See transaction expenses where brokerage data provides them.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Activity Patterns</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Surface unusual trading behavior that may deserve further review.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Advisor Questions</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Turn trading observations into specific issues to discuss with your advisor.</p>
</article>
</div>
</div>
</section>
...
<a href="{{ route('register') }}" class="mt-8 inline-flex rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold hover:bg-blue-500">Check My Trading Activity →</a>
</div>
</div>
</section>
</main>
