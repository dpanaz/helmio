...
<head>
    ...
    <title>Is your portfolio performance actually good? | Helmio</title>
    <meta name="description" content="Returns need context. Helmio compares portfolio results with benchmarks while considering risk and performance history.">
...
<span class="inline-flex rounded-full border border-blue-500/25 bg-blue-500/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[.16em] text-blue-300">ADVISOR PERFORMANCE</span>
<h1 class="mt-7 text-4xl font-semibold tracking-[-.04em] sm:text-5xl lg:text-6xl">Is your portfolio performance actually good?</h1>
<p class="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-400 sm:text-lg">Returns need context. Helmio compares portfolio results with benchmarks while considering risk and performance history.</p>
<div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
<a href="{{ route('register') }}" class="inline-flex min-w-52 items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold hover:bg-blue-500">Review My Performance →</a>
...
<h3 class="mt-5 text-lg font-semibold text-white">Portfolio Returns</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Track historical portfolio performance from your valuation history.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Benchmark Comparison</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Compare results with broad-market benchmarks for context.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Time-Weighted Returns</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Evaluate performance while reducing distortion from deposits and withdrawals.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Risk Context</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">View return alongside volatility, drawdowns, and other risk measures.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Performance History</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">See how results evolve instead of relying on a single statement period.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Independent Oversight</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Use performance as one part of a broader advisor and portfolio review.</p>
</article>
</div>
</div>
</section>
...
<a href="{{ route('register') }}" class="mt-8 inline-flex rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold hover:bg-blue-500">Review My Performance →</a>
</div>
</div>
</section>
</main>
