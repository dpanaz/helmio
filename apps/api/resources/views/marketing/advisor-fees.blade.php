...
<head>
    ...
    <title>Know what your financial advisor is really costing you. | Helmio</title>
    <meta name="description" content="A quoted advisory fee may be only part of the picture. Helmio brings portfolio costs together in one understandable view.">
...
<span class="inline-flex rounded-full border border-blue-500/25 bg-blue-500/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[.16em] text-blue-300">FINANCIAL ADVISOR FEES</span>
<h1 class="mt-7 text-4xl font-semibold tracking-[-.04em] sm:text-5xl lg:text-6xl">Know what your financial advisor is really costing you.</h1>
<p class="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-400 sm:text-lg">A quoted advisory fee may be only part of the picture. Helmio brings portfolio costs together in one understandable view.</p>
<div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
<a href="{{ route('register') }}" class="inline-flex min-w-52 items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold hover:bg-blue-500">Analyze My Investment Fees →</a>
...
<h3 class="mt-5 text-lg font-semibold text-white">Advisory Fees</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Track percentage-based and dollar-based advisory costs across your investment accounts.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Fund Expenses</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Identify expense ratios embedded inside ETFs and mutual funds.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Account Fees</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Surface recurring account-level and administrative charges.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Transaction Costs</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Review trading-related costs where brokerage data provides them.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">All-In Cost Rate</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">See estimated annual portfolio cost in dollars and as a percentage of assets.</p>
</article>
<article class="group rounded-2xl border border-slate-800 bg-slate-900/65 p-6 transition hover:-translate-y-0.5 hover:border-blue-500/30 hover:bg-slate-900">
...
<h3 class="mt-5 text-lg font-semibold text-white">Cost Context</h3>
<p class="mt-2 text-sm leading-6 text-slate-400">Understand which accounts and investments contribute most to total cost.</p>
</article>
</div>
</div>
</section>
...
<a href="{{ route('register') }}" class="mt-8 inline-flex rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold hover:bg-blue-500">Analyze My Investment Fees →</a>
</div>
</div>
</section>
</main>
